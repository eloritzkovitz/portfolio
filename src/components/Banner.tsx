    ...
    <div className="banner h-auto min-h-[60vh] md:h-[calc(100vh-4rem)] flex items-center justify-center overflow-hidden px-2 sm:px-0">
      <div className="relative z-10 w-full max-w-screen-xl mx-auto px-2 sm:px-8 py-8 md:py-10 flex flex-col md:flex-row items-center">
        <div className="flex-1 w-full text-center md:text-left">
          <h1 className="text-4xl xs:text-5xl sm:text-7xl md:text-9xl font-extrabold mb-4 text-gray-900">
            <Typewriter
          ...
          <h2 className="text-lg xs:text-xl sm:text-2xl font-bold mb-4 text-gray-900">
            Full-Stack Developer
          </h2>
          <p className="text-base xs:text-lg sm:text-xl text-gray-900 mb-8">
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-2 mb-8">
            {primarySkills.map((skill, idx) => (
              <span
                key={idx}
                className="tech-tag text-xs xs:text-sm sm:text-base px-2 py-1 sm:px-3 sm:py-1.5 rounded"
              >
                {skill}
              </span>
            ))}
          ...
          <div className="flex gap-4 justify-center md:justify-start mb-6">
            ...
            <a
              ...
              aria-label="Resume"
            >
              <FaIdBadge className="w-7 h-7 sm:w-8 sm:h-8" />
            </a>
          </div>
          <div className="mt-4">
            <Link
              to="/about"
              className="inline-flex text-gray-900 text-base xs:text-lg sm:text-xl font-bold py-2 transform hover:scale-110"
            >
              Learn more &rarr;
            </Link>
          </div>
