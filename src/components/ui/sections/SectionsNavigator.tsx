      ...
      <div className="bg-white rounded-lg shadow-md p-4 flex items-center w-full h-full relative">
        ...
        {navVisible && (
          <SectionNavToggleButton
            ...
            icon={<FaChevronLeft className="w-5 h-5" />}
            className="absolute top-1/2 right-0 -translate-y-1/2 translate-x-1/2 bg-white rounded-full shadow-md w-12 h-12 flex items-center justify-center opacity-0 group-hover:opacity-100 transition"
          />
        )}
      </div>
    </div>
    ...
    {!navVisible && (
      ...
      >
        <SectionNavToggleButton
          ...
          icon={<FaChevronRight className="w-5 h-5" />}
          className="-ml-30 bg-white rounded-full shadow-md p-2 transition flex items-center justify-center"
        />
      </div>
    )}
  </nav>
